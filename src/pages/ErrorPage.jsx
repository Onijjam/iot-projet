...
export default function ErrorPage() {
    return (
        <>
            <main className="grid h-screen w-screen place-items-center bg-gray-900 px-6 py-24 sm:py-32 lg:px-8">
                <div className="text-center">
                    <p className="text-base font-semibold text-blue-600">404</p>
                    <h1 className="mt-4 text-3xl font-bold tracking-tight text-white sm:text-5xl">Page not found</h1>
                    <p className="mt-6 text-base leading-7 text-gray-400">Pardon, nous n'avons pas pu trouver la page que vous cherchiez.</p>
